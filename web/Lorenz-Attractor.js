...
function createWasm() {
	...
	function receiveInstance(instance, module) {
		...
		wasmMemory = wasmExports['ie'];
		updateMemoryViews();
		addOnInit(wasmExports['je']);
...
var ASM_CONSTS = {
	...
	21254: () => document.getElementById('canvas').width,
	21306: () => parseInt(document.getElementById('canvas').style.width),
	21374: () => {
	...
	21520: () => document.getElementById('canvas').width,
	21572: () => screen.width,
	21597: () => {
		document.exitFullscreen();
	},
	...
	21803: () => document.getElementById('canvas').width,
	21855: () => parseInt(document.getElementById('canvas').style.width),
	21923: () => {
		if (document.fullscreenElement) return 1;
	},
	21969: () => document.getElementById('canvas').width,
	22021: () => screen.width,
	22046: () => {
		if (document.fullscreenElement) return 1;
	},
	22092: () => document.getElementById('canvas').width,
	22144: () => screen.width,
	22169: () => {
		document.exitFullscreen();
	},
	...
	22242: () => document.getElementById('canvas').width,
	22294: () => parseInt(document.getElementById('canvas').style.width),
	22362: () => {
		document.exitFullscreen();
	},
	22389: () => screen.width,
	22414: () => screen.height,
	22440: () => window.screenX,
	22467: () => window.screenY,
	22494: ($0) => {
...
var GLFW = {
	...
	onMousemove: (event) => {
		...
		if (GLFW.active.cursorPosFunc) {
			((a1, a2, a3) =>
				dynCall_vidd(GLFW.active.cursorPosFunc, a1, a2, a3))(
				GLFW.active.id,
				Browser.mouseX,
				Browser.mouseY
			);
	...
	onCanvasResize: (width, height, framebufferWidth, framebufferHeight) => {
		...
		if (
			...
			resizeNeeded =
				width != GLFW.active.storedWidth ||
				height != GLFW.active.storedHeight;
	...
	onWindowSizeChanged: () => {
		...
		if (GLFW.active.windowSizeFunc) {
			((a1, a2, a3) =>
				dynCall_viii(GLFW.active.windowSizeFunc, a1, a2, a3))(
				GLFW.active.id,
				GLFW.active.width,
				GLFW.active.height
			);
				...
				if (gamepad) {
					if (!GLFW.joys[joy]) {
						...
						if (GLFW.joystickFunc) {
							((a1, a2) =>
								dynCall_vii(GLFW.joystickFunc, a1, a2))(
								joy,
								262145
							);
						}
	...
	onDrop: (event) => {
		...
		function save(file) {
			...
			reader.onloadend = (e) => {
				...
				if (++written === count) {
					((a1, a2, a3) =>
						dynCall_viii(GLFW.active.dropFunc, a1, a2, a3))(
						GLFW.active.id,
						count,
						filenames
					);
...
var preloadedAudios = {};
var wasmImports = {
	Aa: GetWindowInnerHeight,
	Ba: GetWindowInnerWidth,
	p: ___assert_fail,
	P: ___cxa_throw,
	$a: ___syscall_faccessat,
	...
	Nd: _emscripten_glActiveTexture,
	Md: _emscripten_glAttachShader,
	ce: _emscripten_glBeginQueryEXT,
	Ld: _emscripten_glBindAttribLocation,
	Kd: _emscripten_glBindBuffer,
	Jd: _emscripten_glBindFramebuffer,
	Id: _emscripten_glBindRenderbuffer,
	Hd: _emscripten_glBindTexture,
	Wd: _emscripten_glBindVertexArrayOES,
	Gd: _emscripten_glBlendColor,
	Fd: _emscripten_glBlendEquation,
	Dd: _emscripten_glBlendEquationSeparate,
	Cd: _emscripten_glBlendFunc,
	Bd: _emscripten_glBlendFuncSeparate,
	Ad: _emscripten_glBufferData,
	...
	ee: _emscripten_glDeleteQueriesEXT,
	...
	Rd: _emscripten_glDrawArraysInstancedANGLE,
	Sd: _emscripten_glDrawBuffersWEBGL,
	...
	Ud: _emscripten_glGenVertexArraysOES,
	...
	Gc: _emscripten_glGetBufferParameteriv,
	Fc: _emscripten_glGetError,
	...
	Rb: _emscripten_glStencilFuncSeparate,
	Qb: _emscripten_glStencilMask,
	Pb: _emscripten_glStencilMaskSeparate,
	Ob: _emscripten_glStencilOp,
	Nb: _emscripten_glStencilOpSeparate,
	Mb: _emscripten_glTexImage2D,
	Lb: _emscripten_glTexParameterf,
	Kb: _emscripten_glTexParameterfv,
	Jb: _emscripten_glTexParameteri,
	Ib: _emscripten_glTexParameteriv,
	Hb: _emscripten_glTexSubImage2D,
	Gb: _emscripten_glUniform1f,
	Fb: _emscripten_glUniform1fv,
	Eb: _emscripten_glUniform1i,
	Db: _emscripten_glUniform1iv,
	Cb: _emscripten_glUniform2f,
	Bb: _emscripten_glUniform2fv,
	Ab: _emscripten_glUniform2i,
	...
	ka: _glfwSetWindowContentScaleCallback,
	ma: _glfwSetWindowFocusCallback,
	na: _glfwSetWindowIconifyCallback,
	R: _glfwSetWindowShouldClose,
...
var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports['je'])();
var _main = (Module['_main'] = (a0, a1) =>
	(_main = Module['_main'] = wasmExports['ke'])(a0, a1));
var _malloc = (a0) => (_malloc = wasmExports['me'])(a0);
var _free = (a0) => (_free = wasmExports['ne'])(a0);
var ___cxa_is_pointer_type = (a0) =>
	(___cxa_is_pointer_type = wasmExports['oe'])(a0);
var dynCall_vii = (Module['dynCall_vii'] = (a0, a1, a2) =>
	(dynCall_vii = Module['dynCall_vii'] = wasmExports['pe'])(a0, a1, a2));
var dynCall_viii = (Module['dynCall_viii'] = (a0, a1, a2, a3) =>
	(dynCall_viii = Module['dynCall_viii'] = wasmExports['qe'])(
		a0,
		a1,
		a2,
		a3
...
var dynCall_viff = (Module['dynCall_viff'] = (a0, a1, a2, a3) =>
	(dynCall_viff = Module['dynCall_viff'] = wasmExports['re'])(
		a0,
		a1,
		a2,
		a3
...
var dynCall_viiiii = (Module['dynCall_viiiii'] = (a0, a1, a2, a3, a4, a5) =>
	(dynCall_viiiii = Module['dynCall_viiiii'] = wasmExports['se'])(
		a0,
		a1,
		a2,
		a3,
...
var dynCall_viiii = (Module['dynCall_viiii'] = (a0, a1, a2, a3, a4) =>
	(dynCall_viiii = Module['dynCall_viiii'] = wasmExports['te'])(
		a0,
		a1,
		a2,
		a3,
...
var dynCall_vidd = (Module['dynCall_vidd'] = (a0, a1, a2, a3) =>
	(dynCall_vidd = Module['dynCall_vidd'] = wasmExports['ue'])(
		a0,
		a1,
		a2,
		a3
...
var dynCall_iiii = (Module['dynCall_iiii'] = (a0, a1, a2, a3) =>
	(dynCall_iiii = Module['dynCall_iiii'] = wasmExports['ve'])(
		a0,
		a1,
		a2,
		a3
...
var dynCall_vi = (Module['dynCall_vi'] = (a0, a1) =>
	(dynCall_vi = Module['dynCall_vi'] = wasmExports['we'])(a0, a1));
var _asyncify_start_unwind = (a0) =>
	(_asyncify_start_unwind = wasmExports['xe'])(a0);
var _asyncify_stop_unwind = () => (_asyncify_stop_unwind = wasmExports['ye'])();
var _asyncify_start_rewind = (a0) =>
	(_asyncify_start_rewind = wasmExports['ze'])(a0);
var _asyncify_stop_rewind = () => (_asyncify_stop_rewind = wasmExports['Ae'])();
var calledRun;
